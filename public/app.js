...
const data = __webpack_require__(16);
...
exports.importData = (URL, data) => {
	switch (URL) {
		case URLs[0]:
			...
			break;
		case URLs[1]:
			diarycalendar_events = data;
			exports.diarycalendar_events = diarycalendar_events;
			break;
		case URLs[2]:
			timetable_dailytimetable = data;
			exports.timetable_dailytimetable = timetable_dailytimetable;
			break;
		case URLs[3]:
			timetable_timetable = data;
			exports.timetable_timetable = timetable_timetable;
			break;
		case URLs[4]:
			details_participation = data;
			exports.details_participation = details_participation;
			break;
		case URLs[5]:
			details_userinfo = data;
			exports.details_userinfo = details_userinfo;
			break;
		case URLs[6]:
			timetable_bells = data;
			exports.timetable_bells = timetable_bells;
			break;
		case URLs[7]:
			calendar_days = data;
...
exports.exportData = URL => {
	switch (URL) {
		case URLs[0]:
			return exports.dailynews_list;
			break;
		case URLs[1]:
			return diarycalendar_events;
			break;
		case URLs[2]:
			return timetable_dailytimetable;
			break;
		case URLs[3]:
			return timetable_timetable;
			break;
		case URLs[4]:
			return details_participation;
			break;
		case URLs[5]:
			return details_userinfo;
			break;
		case URLs[6]:
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Timetable_Timetable__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__About_About__ = __webpack_require__(17);
...
class App extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'nav',
        { id: 'navbar', className: 'uk-navbar uk-navbar-container uk-margin', 'uk-navbar': 'true', height: '70px' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
